...
TOCOPY="apps bin build data script extern src Makefile grapic.lua premake* README.md lifami.bat"

TOZIP_SHORT="apps data src Makefile grapic.lua premake4.lua README.md script/lifami.lua"
