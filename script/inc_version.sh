...
echo "<LI> <a href=\"../download/grapic-$A.$B.${C}_WinCB20.zip\"> grapic-${A}.${B}.${C}_WinCB20.zip (WINDOWS/Codeblocks-20.03/Mingw) </a>"  >> ../doc/VERSION.html
...
echo "<LI> <a href=\"../download/grapic-$A.$B.${C}_WinCB17.zip\"> grapic-${A}.${B}.${C}_WinCB17.zip (WINDOWS/Codeblocks-17.12/Mingw) </a>"  >> ../doc/VERSION.html
echo "</UL>" >> ../doc/VERSION.html
